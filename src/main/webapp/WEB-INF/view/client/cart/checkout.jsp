                                    ...
                                    <div class="bg-light rounded">
                                        <div class="p-4">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <h5 class="mb-0 me-4">Shipping Type</h5>
                                                <div class="">
                                                    <p class="mb-0">Pay on Delivery(COD)</p>
                                                </div>
                                            </div>
                                        ...
                                        <form:form method="post" action="/place-order" modelAttribute="cart">
                                            ...
                                            <div class="mb-3">
                                                <label for="recipientName" class="form-label">Receiver Name</label>
                                                <input class="form-control" name="receiverName"
                                                    placeholder="Enter receiver name" required="true" />
                                            </div>
                                            <div class="mb-3">
                                                <label for="recipientPhone" class="form-label">Receiver Phone</label>
                                                <input class="form-control" name="receiverPhone"
                                                    placeholder="Enter receiver phone" required="true" />
                                            </div>
                                            <div class="mb-3">
                                                <label for="recipientAddress" class="form-label">Receiver
                                                    Address</label>
                                                <input class="form-control" name="receiverAddress"
                                                    placeholder="Enter receiver address" required="true" />
                                            </div>
                                            <button
